        ...
        try {
            ...
            await (0, rxjs_1.from)(contractsTree)
                ...
                return (0, rxjs_1.defer)(async () => {
                    if (preload_1.default.lte(this.compilerVersion, "0.66.0")) {
                        ...
                        return (0, util_1.promisify)(child_process_1.exec)(`cd ${this.options.build} && \
          ${this.config.compilerPath} ${!this.options.disableIncludePath ? includePath : ""} ${path}`);
                    ...
                    if (preload_1.default.gte(this.compilerVersion, "0.68.0")) {
                        ...
                        return (0, util_1.promisify)(child_process_1.exec)(` ${this.config.compilerPath} ${!this.options.disableIncludePath ? includePath : ""} -o ${this.options.build}  ${path}`);
                    }
